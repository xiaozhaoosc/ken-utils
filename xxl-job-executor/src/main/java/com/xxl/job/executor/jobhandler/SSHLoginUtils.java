...
//            }
     ...
     * @param ip       目标主机名或ip
     */
    public static Session getSession(String ip, String password) {
     ...
     * @param ip       目标主机名或ip
     */
    public static Session getSession(String ip, String username, String password, Integer port) {
